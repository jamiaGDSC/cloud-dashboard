...
try{
  ...
  return (
    <>
      ...
      <nav className='w-full  shadow-md relative '>
        ...
        <div className="p-3 flex mob:flex-col m-auto max-w-6xl justify-between items-center">
          ...
          <div className="links mob:py-3 flex justify-center items-center space-x-5">
            ...
            <Link href="https://www.linkedin.com/company/google-developer-student-club-jmi/"><div className="cursor-pointer linkedin">
            ...
            <Link href="https://www.instagram.com/gdsc_jmi/"><div className="cursor-pointer insta">
      ...
      <div className="  w-full p-2 text-center bg-gray-900 text-gray-300">Developed By <a href="" className="text-orange-400">GDSC JMI</a> </div>
    </>
  )
}
catch(error){
